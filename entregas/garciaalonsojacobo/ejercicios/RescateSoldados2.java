...
public class RescateSoldados2 {
    ...
    public static void main(String[] args) {
        ...
        String mensaje = quedanSoldados == false ? "¡MISIÓN COMPLETADA! Soldados rescatados = " + SOLDADOS
                : "MISIÓN FALLIDA. Se acabaron los turnos, con un total de intentos= " + contadorTurnos;
